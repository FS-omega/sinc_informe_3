...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2023 a las 01:58:24
-- Versión del servidor: 10.4.24-MariaDB
-- Versión de PHP: 7.4.29
CREATE DATABASE IF NOT EXISTS cft;
USE cft;
...
CREATE TABLE if not exists`carr_mod` (
...
CREATE TABLE `jefe_carrera` (
  `id_jefe` int(10) NOT NULL,
  `id_docentedocente` int(10) DEFAULT NULL,
  `estado_id` int(10) DEFAULT NULL,
...
CREATE TABLE `carrera` (   `id_carrera` int(10) NOT NULL,   `nombre_c` char(10) DEFAULT NULL,   `fecha_hora` datetime DEFAULT NULL,   `modulo_id` int(255) NOT NULL,   `id_jefe` int(10) NOT NULL,   `jornada_id` int(10) NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
